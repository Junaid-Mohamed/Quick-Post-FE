...
import { fetchUserPosts } from "../features/Posts/postSlice.js";
import { fetchSecondaryUser, updateUserFollower, updateUserProfile } from "../features/User/userSlice.js";
...
const UserProfileScreen = () => {
    ...
    const secondaryUser = useSelector((state)=> state?.users.secondaryUser);
    // console.log("secondary user",secondaryUser);
    const {userPosts,postSliceStatus} = useSelector((state)=> state?.posts);
