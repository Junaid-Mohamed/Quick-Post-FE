...
import { getMediaType, getRelativeTime } from "../../config/utils.js";
import { deleteUserPost, editUserPost, likePost } from "../../features/Posts/postSlice.js";
import { fetchSecondaryUser, updateBookmarkedPost } from "../../features/User/userSlice.js";
...
const PostCard = ({post,page}) => {
    ...
    const mediaType = getMediaType(post.resourceType, post.imageUrl)
